  ...
  return (
    <div className="card-body">
      ...
      <ol>
        <li>
          <p>
            Upload Your Data File: This is the large, messy document you want to
            search through (like a giant spreadsheet, a banking log, or a health
            record).
          </p>
        </li>
        <li>
          <p>
            Upload Your "Cheat Sheet" (The Schema): Instead of typing in every
            single thing you’re looking for, you upload a small instruction file
            (a "schema"). Think of this as a digital cheat sheet or a blueprint
            that tells the app exactly what a phone number, account digit, or
            text pattern looks like.
          </p>
        </li>
        <li>
          <p>
